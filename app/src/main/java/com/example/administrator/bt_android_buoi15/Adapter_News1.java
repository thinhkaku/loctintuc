...
public class Adapter_News1 extends ArrayAdapter<ItemDataWeb> {
    private LayoutInflater inflater;
    private ArrayList<ItemDataWeb>arrNews;
    private HolderNews holderNews;
    public Adapter_News1(@NonNull Context context, @NonNull ArrayList<ItemDataWeb> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ItemDataWeb item_news = arrNews.get(position);
